...
export default function KoreanErrorPage({ error, reset }: ErrorPageProps) {
  useEffect(() => {
    console.error('Korean route error boundary caught error:', error);
  }, [error]);
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 flex items-center justify-center p-4 text-gray-100">
      <div className="max-w-md mx-auto text-center space-y-6">
        ...
        <h1 className="text-2xl font-bold text-white font-santokki">문제가 발생했습니다</h1>
