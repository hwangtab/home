    ...
    <div className={className}>
      ...
      {(showLabel || label) && (
        <div className="flex justify-between items-center mb-2">
          <span className="text-sm font-medium text-gray-200 font-wanted-sans">
            {label}
          </span>
          {showPercentage && (
      ...
      <div className={`w-full ${backgroundClasses[color] || backgroundClasses.gray} rounded-full ${sizeClasses[size] || sizeClasses.medium}`}>
        <motion.div
          className={`${sizeClasses[size] || sizeClasses.medium} ${colorClasses[color] || colorClasses.blue} rounded-full relative overflow-hidden`}
          initial={{ width: 0 }}
        ...
        <div className="flex flex-wrap gap-4 mt-3">
          {items.map((item, index) => (
            <div key={index} className="flex items-center">
              ...
              <span className="text-sm text-gray-300 font-wanted-sans">
        ...
        {steps.map((step, index) => (
          <React.Fragment key={index}>
            ...
            <div className="flex flex-col items-center">
              ...
              <span className={`text-xs mt-2 text-center font-wanted-sans ${
...
export const LoadingProgress = memo(({ 
  ...
  return (
    <div className={`flex flex-col items-center ${className}`}>
      ...
      {message && (
        <span className="text-sm text-gray-400 mt-2 font-wanted-sans">
          {message}
        </span>
      )}
    </div>
